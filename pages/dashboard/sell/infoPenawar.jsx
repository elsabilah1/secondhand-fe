      ...
      <div className="mx-auto my-6 flex max-w-2xl px-4 md:my-10">
        ...
        <div className="w-full space-y-4 md:w-10/12">
          ...
          <div className="flex justify-end gap-4">
            ...
            <button className="w-40 rounded-2xl border border-primary-04 bg-primary-04 py-2 px-6 text-neutral-01 transition-all hover:border-primary-03 hover:bg-primary-03 focus:outline-none focus:ring focus:ring-primary-01 active:scale-95">
